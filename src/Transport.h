...
*/
	...
	public:
		...
		inline static size_t path_states_size() { return _path_states.size(); }
		inline static uint16_t path_states_maxsize() { return _path_states_maxsize; }
		inline static void path_states_maxsize(uint16_t path_states_maxsize) { _path_states_maxsize = path_states_maxsize; }
	...
	private:
		...
		static uint16_t _path_states_maxsize;
