...
namespace RNS { namespace Type {
	...
	namespace Reticulum {
		...
		*/
		...
		// IFAC HKDF salt, matching RNS.Reticulum.IFAC_SALT byte-for-byte. Held
		// as hex; construct a Bytes via assignHex() at use.
		static constexpr const char* IFAC_SALT = "adf54d882c9a9b80771eb4995d702d4a3e733391b2a0f53f416d9f907e55cff8";
...
*/
	...
	namespace Resource {
		...
		// Firmware port: hybrid RAM-vs-flash buffer for receive AND
		// the sender's ciphertext-spill cutoff (Resource::_build_outgoing).
